...
public class ITApplicationService {
    ...
    public ITApplication findITApplication(Long id) {
        return itApplicationRepository.findById(id).orElseThrow(ResourceNotFoundException::new);
    }
    ...
    public ITApplication getITApplication(Long applicationId) {
        return itApplicationRepository.findById(applicationId).orElseThrow(ResourceNotFoundException::new);
    }
}
