...
public class StrategyService {
    ...
    public Strategy findStrategy(Long id) {
        return strategyRepository.findById(id).orElseThrow(ResourceNotFoundException::new);
    }
    ...
    public Strategy updateStrategy(Long strId, Strategy strategy) {
        ...
        Strategy oldStrategy = strategyRepository.findById(strId).orElseThrow(ResourceNotFoundException::new);
