    ...
    void givenCapStrategyItems_WhenGetAllCapStrategyItems_ThenReturnAllCapStrategyItems() {
           ...
           Capability capability = new Capability("testCapbility",environment);
            capability.setId(capabilityId);
             ...
             strategyItem.setId(strItemID1);

           

             StrategyItem strategyItem2 = new StrategyItem("name2","description2");
            strategyItem.setStrategy(strategy);
            strategyItem2.setId(strItemID2);

            CapStrategyItems test1=  new CapStrategyItems(capability, strategyItem2, StrategicEmphasis.LOW);
           
            CapStrategyItems test2= new CapStrategyItems(capability, strategyItem, StrategicEmphasis.HIGH);
         
             //When
            when(capStrategyItemsService.getCapabilityStrategyItems(capabilityId)).thenReturn(Arrays.asList(test1,test2));
