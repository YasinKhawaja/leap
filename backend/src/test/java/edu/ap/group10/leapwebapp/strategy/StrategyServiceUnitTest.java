...
//         //Given
//         Long strId = 10L;
//         Strategy strategy = new Strategy("test", "2020-02-01","2021-02-01", new Environment("test"));
...
//         //Given
//         Long strId = 5L;
//         Strategy oldStrategy = new Strategy("test", "2020-02-01","2021-02-01", new Environment("test"));
//         oldStrategy.setId(strId);
//         when(strategyRepository.findById(strId)).thenReturn(Optional.of(oldStrategy));

//         Strategy newStr = new Strategy("name", "2020-02-20","2021-02-01",new Environment("hallo"));
...
//         //When
//         Boolean deleted = strategyService.deleteStrategy(strId);
